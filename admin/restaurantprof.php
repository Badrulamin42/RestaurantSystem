...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border">
                <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New</a> <a href="exampleinvoice.php"  target="_blank"  class="btn btn-info btn-sm btn-flat"></i>Show Invoice</a>
              </div>
              <div class="box-body">
    ...
    <?php include 'includes/restaurant_modal.php'; ?>
