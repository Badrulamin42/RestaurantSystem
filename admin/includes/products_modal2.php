        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_delete.php">
                ...
                <input type="hidden" class="photo" name="delete_file" />
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
           ...
           <h2 class="bold name"></h2>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_status.php">
                <input type="hidden" class="prodid" name="id">
                <input type="hidden" class="form-control" id="edit_name" name="name">
                <input type="hidden" class="form-control" id="edit_category" name="category">
                <input type="hidden" class="form-control" id="edit_price" name="price">
                <textarea id="editor2" name="description" rows="10" cols="80" hidden></textarea>
                <div class="form-group">
              

                  <label for="isactive" class="col-sm-1 control-label">Status</label>

                  <div class="col-sm-5">
                    <select class="form-control" id="edit_isactive" name="isActive">
                      <option selected id="isActiveselected"></option>
                    </select>
                  </div>
                </div>
